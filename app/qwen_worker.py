...
class QwenWorkerClient:
    def __init__(self) -> None:
        ...
        self.timeout = httpx.Timeout(connect=30.0, read=1800.0, write=1800.0, pool=30.0)
    ...
    async def transcribe_align(
        ...
        *,
        ...
        if response.is_error:
            raise QwenWorkerError(payload.get("detail") or f"Qwen Worker HTTP {response.status_code}")
        return payload
